...
func TestDocHelp(t *testing.T) {
	...
	cmd.Env = append(os.Environ(), "BUILDER_MAIN=1")
	help, err := cmd.Output()
	if err != nil {
		t.Fatal(err)
	}
	...
	if *updateDocs {
		...
		contents := fmt.Sprintf(`// Code generated by TestDocHelp; DO NOT EDIT.
...
`, strings.Join(lines, "\n"))
		...
		if err := os.WriteFile("doc.go", data, 0o666); err != nil {
